...
BOOL XEngine_Client_TaskSend(LPCTSTR lpszClientAddr, XENGINE_PROTOCOLHDR* pSt_ProtocolHdr, LPVOID lParam, int nNetType, LPCTSTR lpszMsgBuffer = NULL, int nMsgLen = 0);
