...
/*                         网络服务导出函数                             */
/************************************************************************/
extern "C" XBOOL Session_Authorize_Init(CALLBACK_XENGIEN_AUTHORIZE_SESSION_CLIENT_EVENTS fpCall_AuthEvent, XPVOID lParam)
{
	return m_SessionAuth.Session_Authorize_Init(fpCall_AuthEvent, lParam);
}
extern "C" XBOOL Session_Authorize_GetClient(AUTHSESSION_NETCLIENT * **pppSt_ListClient, int* pInt_ListCount, LPCXSTR lpszClientAddr)
{
...
extern "C" XBOOL Session_Authorize_Insert(LPCXSTR lpszClientAddr, AUTHREG_USERTABLE * pSt_UserTable, int nNetType)
{
...
/*                         TOKEN会话导出函数                            */
/************************************************************************/
extern "C" XBOOL Session_Token_Init(int nTimeout, CALLBACK_XENGIEN_AUTHORIZE_SESSION_TOKEN_EVENTS fpCall_AuthEvent, XPVOID lParam)
{
...
extern "C" XBOOL Session_Token_Insert(XNETHANDLE xhToken, AUTHREG_USERTABLE * pSt_UserTable, int nTimeout)
{
...
extern "C" XBOOL Session_Token_Get(XNETHANDLE xhToken, AUTHREG_USERTABLE * pSt_UserTable)
{
